# Have students create methods that will list all the events on a date, create another attribute of type of event then create a method that list all events of a type, 
import csv
class calendar:
